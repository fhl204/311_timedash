...
mapbox_access_token = 'pk.eyJ1IjoiZmhsMjA0IiwiYSI6ImNqZ3ptbm83azB4cmoycGxlN2h6MzFueDIifQ.lNLxfYi0QYdmOBCDM-icAw'

def initialize():
    df = pd.read_csv('3112011.csv')
    #df = pd.read_csv('https://data.cityofnewyork.us/dataset/311-Service-Requests-From-2011/fpz8-jqf4')
    ...
    df.drop("Created Date", 1, inplace=True)
...
app.layout = html.Div([
    html.Div([
        html.Div([
            ...
            html.Div([
                html.Div([
                    html.H2("NYC 311 Round the Clock Call Frequency", style={'font-family': 'Dosis'}),
                    html.Img(src="311-srmap.jpg",
                            style={
                                'height': '100px',
                                'float': 'right',
                                'position': 'relative',
                ...
                html.P("Select month using the dropdown and the slider to select day\
        ...
        dcc.Markdown("Source: [311 NYC OpenData](https://nycopendata.socrata.com/Social-Services/311-Service-Requests-from-2010-to-Present/erm2-nwe9)",
                     className="source"),
        dcc.Checklist(
            id="mapControls",
            options=[
...
def update_total_rides_selection(value, slider_value, selection):
    ...
    return ("Total calls in category: {:,d}"
